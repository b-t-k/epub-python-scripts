...
pages_list_nonfiction=[
    [['about-the-author.xhtml'],
     ...
     ['<figure class="author">[\n\r\t\s]*<img.*?src="(.*?)".*?/>',lambda x:'<figure class="author">\n<img class="author" src="' + x.group(1) + '" alt="A color photo of the author, ADD_NAME_HERE" />\n'],
     ],
    ],
]
...
list_nav=[
    ...
    <nav id="landmarks" epub:type="landmarks" aria-labelledby="nav_landmarks">
        ...
        <li><a href="resources.xhtml" epub:type="backmatter">Resources</a></li>
        <li><a epub:type="backmatter" href="glossary.xhtml">Glossary</a></li>
        <li><a epub:type="backmatter" href="acknowledgments.xhtml">Acknowledgments</a></li>
        <li><a epub:type="backmatter" href="index.xhtml">Index</a></li>
